...
const DiscoverGateway = () => {
    return (
        <div className="relative overflow-hidden my-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6 p-8 bg-[#210F53] rounded-lg md:h-[400px] my-22 md:border border-none dark:border-white/30 max-w-screen-xl m-auto mx-4 md:mx-auto">
