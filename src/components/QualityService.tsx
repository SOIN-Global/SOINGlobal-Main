    ...
    return (
        <div className="relative py-6 md:py-12 px-4 md:my-[170px]">
            ...
            <div className="md:absolute md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 flex flex-col gap-6 md:gap-28 text-black/80 dark:text-white/80 ">
                ...
                <div className="w-full md:w-[600px] lg:w-[700px] md:h-[350px] md:ml-[200px] lg:ml-[300px] gradient-border-light rounded-3xl">
                    <div className="flex flex-col w-full h-full gap-1 md:gap-4 justify-center bg-[linear-gradient(to_top,#F5FCFC_20%,#ffffff_80%)] dark:bg-none dark:bg-[#0C1526] rounded-3xl p-8 m-auto">
                ...
                <div className="w-full md:w-[600px] lg:w-[700px] md:h-[350px] gradient-border-light rounded-3xl">
                    <div className="flex flex-col w-full h-full gap-1 md:gap-4 justify-center bg-[linear-gradient(to_top,#F5FCFC_20%,#ffffff_80%)] dark:bg-none dark:bg-[#0C1526] rounded-3xl p-8 border-white/20 border m-auto md:m-0">
                ...
                <div className="w-full md:w-[600px] lg:w-[700px] md:h-[350px] md:ml-[200px] lg:ml-[300px] gradient-border-light rounded-3xl">
                    <div className="flex flex-col gap-1 w-full h-full md:gap-4 justify-center bg-[linear-gradient(to_top,#F5FCFC_20%,#ffffff_80%)] dark:bg-none dark:bg-[#0C1526]  rounded-3xl p-8 border-white/20 border m-auto">
