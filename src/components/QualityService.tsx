    ...
    return (
        <div className="relative py-6 md:py-12 px-4 md:my-[170px]">
            ...
            <div className="md:absolute md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 flex flex-col gap-6 md:gap-28 text-black/80 dark:text-white/80 ">
                <div className="flex flex-col gap-1 md:gap-4 justify-center bg-[#C6EFEF] dark:bg-[#0C1526] w-full md:w-[600px] md:h-[350px] md:ml-[200px] rounded-lg p-6 border-white/20 border m-auto">
                    <h3 className="text-[#09C2B8] dark:text-white text-2xl font-bold">Analyze</h3>
                    ...
                    <h3 className="hidden md:block absolute -left-12 text-[#4EA9A9] dark:text-[#C6EFEF] text-4xl font-bold">DISCOVER</h3>
                </div>
                <div className="flex flex-col gap-1 md:gap-4 justify-center bg-[#C6EFEF] dark:bg-[#0C1526] w-full md:w-[600px] md:h-[350px] rounded-lg p-6 border-white/20 border m-auto md:m-0">
                    ...
                    <div className="flex items-center flex-col-reverse md:flex-row gap-4">
                        ...
                        <p>SOIN&aposs intelligent algorithms connect you with the most relevant, Our unified platform seamlessly connects brands with verified influencers and service providers using intelligent AI insights, making collaboration effortless.</p>
                    </div>
                    <h3 className="hidden md:block absolute -right-2 lg:-right-10 text-[#A1920E] dark:text-[#C6EFEF] text-4xl font-bold ">OPTIMIZE</h3>
                </div>
                <div className="flex flex-col gap-1 md:gap-4 justify-center bg-[#C6EFEF] dark:bg-[#0C1526] w-full md:w-[600px] md:h-[350px] md:ml-[200px] rounded-lg p-6 border-white/20 border m-auto">
                    ...
                    <h3 className="hidden md:block absolute left-2 text-[#5B4A9A] dark:text-[#C6EFEF] text-4xl font-bold">SCALE</h3>
                </div>
            </div>
        </div>
    )
