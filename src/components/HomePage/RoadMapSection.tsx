...
export default function RoadMapSection() {
  const roadmapPhases: RoadmapPhase[] = [
    {
      id: "q1-2026",
      year: "Q1",
      title: "Q1 2026 (MVP & Core Development)",
      subtitle: "",
      items: [
  ...
  return (
    <div
      id="roadmap"
      className="flex flex-col items-center justify-center gap-4 py-6 md:py-8 lg:py-10 px-4 sm:px-6 md:px-10 lg:px-20 xl:px-40 bg-black"
      style={{
            ...
            <div className="lg:col-span-9 flex flex-col gap-3 md:gap-4">
              ...
              <ul className="flex flex-col gap-2 md:gap-3">
                {phase.items.map((item, index) => (
                  <li
                    key={index}
                    className="flex items-center justify-start gap-2 md:gap-3 text-muted-foreground"
                  >
                    <span className=" ">•</span>
