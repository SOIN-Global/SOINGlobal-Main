    ...
    return (
        ...
        >
            ...
            <motion.div 
                ...
                viewport={{ once: true, margin: "-100px" }}
                className='grid grid-cols-1 lg:grid-cols-2 items-center gap-4 md:gap-6 lg:gap-8  rounded-2xl p-4 md:p-6 py-6 md:py-8 lg:py-10  w-full max-w-7xl'
            >
                <motion.div 
                    ...
                    viewport={{ once: true, margin: "-100px" }}
                    className='bg-card h-fit p-3 md:p-4 py-4 md:py-12 rounded-2xl flex flex-col items-center justify-center gap-3 md:gap-4'
                >
            ...
            <motion.div 
                ...
                viewport={{ once: true, margin: "-100px" }}
                className='grid grid-cols-1 lg:grid-cols-2 items-center gap-4 md:gap-6 lg:gap-8  rounded-2xl p-4 md:p-6  w-full max-w-7xl'
            >
                    <ForCreatorsSection />
                <motion.div 
                    initial={{ opacity: 0, x: 40 }}
