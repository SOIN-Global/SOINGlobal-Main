        ...
        <div className=" bg-[#48A3A4]/10 mt-12">
            <div className="flex justify-between flex-wrap text-black/80 dark:text-white/80 py-6 md:py-12 max-w-screen-xl m-auto px-4">
                <div className="w-full md:w-60 lg:w-80 mb-6 md:mb-0">
                    <div className="mb-5">
                        <Link target="_blank" href="/" className="text-2xl flex items-center gap-2">
                ...
                <div className="w-full md:w-3/5 flex">
                    <div className="w-1/3">
                        ...
                        <li className="mb-3 list-none">
                            <Link target="_blank" href="https://soin-global.gitbook.io/soin-social-intelligence">Docs</Link>
                        </li>
                        <li className="mb-3 list-none">
                            <Link href="/blog">Blogs</Link>
                        </li>
                        <li className="mb-3 list-none">
                            <Link target="_blank" href="https://t.me/SOINGLOBALAnnoucement">News letter</Link>
                        </li>
                    </div>
                    <div className="w-1/3">
