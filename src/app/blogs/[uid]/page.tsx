    ...
    try {
        ...
        return (
            <div className="min-h-screen bg-black">
                ...
                <div className=" p-6 md:p-12 lg:p-16 mt-20">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
                    <div className="relative w-full h-[50vh] md:h-[60vh] lg:h-[70vh] rounded-xl overflow-hidden">
                ...
                <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
                    ...
                    {/* Main Content */}
                    <div className="text-white prose prose-invert prose-lg max-w-none
            ...
            prose-ul:text-white prose-ul:mb-6
            prose-ol:text-white prose-ol:mb-6
          ...
          ">
                    ...
                    {data.content_sections && data.content_sections.length > 0 && (
                        <div className="mt-12 space-y-12">
                            {data.content_sections.map((section: any, index: number) => (
                                <div key={index} className="space-y-6">
                                    ...
                                    {section.section_description && (
                                        <div className="text-muted-foreground prose prose-invert prose-lg max-w-none
                                            ...
                                            prose-strong:text-white prose-strong:font-semibold
                                            prose-ul:text-white prose-ul:mb-4
                                            prose-ol:text-white prose-ol:mb-4
                                            prose-li:mb-2 prose-li:text-white
                                            prose-a:text-primary prose-a:no-underline hover:prose-a:underline
                                        ">
                                    ...
                                    {section.section_image?.url && (
                                        <div className="relative w-full h-[300px] md:h-[400px] lg:h-[500px] rounded-xl overflow-hidden">
                                            <Image
                                                ...
                                                alt={section.section_image.alt || `Section ${index + 1} image`}
                                                fill
                                                className="object-cover"
                                            />
                                        </div>
